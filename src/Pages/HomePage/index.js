...
import userInfo from "../../api/Auth/getUserInfo";
          ...
          <Col lg={8}>
            <Card>
              <Card.Header>
                ...
                <Link to={"#"} className="text-green text-decoration-none">
                  View Records
                </Link>
              </Card.Header>
              <Card.Body>
