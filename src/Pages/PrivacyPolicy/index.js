    ...
    <>
      ...
      <div className={classes.content}>
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in Peacemaker. This policy is not applicable to any
        ...
        <p>
          Peacemaker follows a standard procedure of using log files. These files log visitors when they visit websites.
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Peacemaker.</p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
          in their respective advertisements and links that appear on Peacemaker, which are sent directly to users'
        ...
        <p>
          Note that Peacemaker has no access to or control over these cookies that are used by third-party advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>

        <p>
          Peacemaker's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
        ...
        <p>
          Peacemaker does not knowingly collect any Personal Identifiable Information from children under the age of 13.
